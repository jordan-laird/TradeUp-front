...
import { Container, Button, Form, Divider, Modal, Image, Header } from 'semantic-ui-react'
...
export class SelectedCompanyContainer extends React.Component{
    ...
    render(){
        ...
        return(
            <Container style={{ height: `${window.innerHeight}px`, overflowY: 'scroll' }}>
                ...
                <Modal  trigger={<Button>Purchase Shares</Button>}>
                    <Modal.Header>Purchase Shares of {currentCompany.companyName}</Modal.Header>
                    <Modal.Content image>
