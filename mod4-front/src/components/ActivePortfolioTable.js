            ...
            <Table>
                ...
                {filtered.map(transactionInfo =>(
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>{this.props.currentPrices[transactionInfo.stock_symbol] ? (this.props.currentPrices[transactionInfo.stock_symbol].close - transactionInfo.purchased_price).toFixed(2) : null}</Table.Cell>
